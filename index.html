...
<body>
    <div class="container">
        ...
        <p>You recently requested to reset your password for your Goopay account.</p>
        <p>To reset your password, use the following code</p>
        
        <h5 style="text-align: center; font-size: 15px; background: #f3f3f3; padding: 10px; border-radius: 5px;">
           {{ $otp }}
        </h5>
